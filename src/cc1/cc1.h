...
enum warning
{
	...
	WARN_COMPARE_MISMATCH = 1 << 4,
	WARN_RETURN_TYPE      = 1 << 5,
	WARN_SIGN_COMPARE     = 1 << 6,
	WARN_EXTERN_ASSUME    = 1 << 7,
	WARN_IMPLICIT_FUNC    = 1 << 8,
	WARN_IMPLICIT_INT     = 1 << 9,
	WARN_VOID_ARITH       = 1 << 10,
};
