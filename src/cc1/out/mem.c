		...
		const out_val *arg2)
{
	...
	/* remove potential struct types (generated by struct lvalue expressions) */
	arg1 = out_change_type(octx, arg1, voidp);
	arg2 = out_change_type(octx, arg2, voidp);
		...
		unsigned long nbytes)
{
	...
	if(should_use_libc(nbytes)){
		...
		if(cc1_fopt.verbose_asm)
			out_comment(octx, "generated memcpy of %lu bytes", nbytes);
