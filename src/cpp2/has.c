...
{
#define NAME(x, t, cat) if(!strcmp(nam, #x) || !strcmp("__" #x "__", nam)) return 1;
#define ALIAS(s, x, t, cat) if(!strcmp(nam, s) || !strcmp("__" s "__", nam)) return 1;
#define EXTRA_ALIAS(s, x, cat) ALIAS(s, x, 0, cat)
	ATTRIBUTES
#undef NAME
#undef ALIAS
#undef EXTRA_ALIAS
