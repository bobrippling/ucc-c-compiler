...
bootstrap/stage2/${CONFIGURE_OUTPUT}: tools/link_r
	...
	cd bootstrap/stage2 && ../../configure CC=${PWD}/src/ucc/ucc 'CFLAGS=${CFLAGS_BOOTSTRAP}'
...
bootstrap/stage3/${CONFIGURE_OUTPUT}:
	...
	cd bootstrap/stage3 && ../../configure CC=${PWD}/bootstrap/stage2/src/ucc/ucc 'CFLAGS=${CFLAGS_BOOTSTRAP}'
